...
- Ce cours adopte une approche moderne : il n'y a pas de support papier. Les slides (qui n'en sont pas) sont accessibles sur le dépôt GitHub du cours.  
- Il est donc essentiel de vous familiariser avec GitHub. Une partie du cours sera dédiée à son apprentissage.
- Certain parties sont enregistrées en vidéo, et vous pourrez les revoir à votre guise.
